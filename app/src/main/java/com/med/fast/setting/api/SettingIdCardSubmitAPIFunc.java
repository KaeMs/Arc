...
public class SettingIdCardSubmitAPIFunc extends AsyncTask<SettingIdCardSubmitAPI, Integer, ResponseAPI> {
    private SettingAPIIntf delegate;
    private Context context;
    private ProgressDialog progressDialog;

    public SettingIdCardSubmitAPIFunc(Context context) {
    ...
    @Override
    protected ResponseAPI doInBackground(SettingIdCardSubmitAPI... params) {
        ResponseAPI responseAPI = new ResponseAPI();
        try {
            String url = APIConstants.API_URL + APIConstants.SETTING_IDCARD_SUBMIT;
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishSettingIdCardSubmit(responseAPI);
