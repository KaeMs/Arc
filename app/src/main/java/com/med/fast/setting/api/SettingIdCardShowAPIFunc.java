...
public class SettingIdCardShowAPIFunc extends AsyncTask<SettingIdCardShowAPI, Integer, ResponseAPI> {
    private SettingAPIIntf delegate;
    private Context context;
    private ProgressDialog progressDialog;

    public SettingIdCardShowAPIFunc(Context context) {
    ...
    @Override
    protected ResponseAPI doInBackground(SettingIdCardShowAPI... params) {
        ResponseAPI responseAPI = new ResponseAPI();
        try {
            String url = APIConstants.API_URL + APIConstants.SETTING_IDCARD_SHOW;
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishSettingIdCardShow(responseAPI);
