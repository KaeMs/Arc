...
public class MiscEditShowAPIFunc extends AsyncTask<MiscShowAPI, Integer, ResponseAPI> {
    private MiscEditIntf delegate;
    private Context context;

    public MiscEditShowAPIFunc(Context context) {
    ...
    protected ResponseAPI doInBackground(MiscShowAPI... params) {
        ...
        try {
            String url = APIConstants.API_URL + "/misc/misceditshow";
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishMiscEditShow(responseAPI);
    }
}
