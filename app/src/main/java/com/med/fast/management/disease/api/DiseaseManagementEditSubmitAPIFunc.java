...
import com.med.fast.management.disease.diseaseinterface.DiseaseManagementEditSubmitIntf;
...
public class DiseaseManagementEditSubmitAPIFunc extends AsyncTask<DiseaseManagementEditSubmitAPI, Integer, ResponseAPI> {
    private DiseaseManagementEditSubmitIntf delegate;
    ...
    public void setDelegate(DiseaseManagementEditSubmitIntf delegate) {
