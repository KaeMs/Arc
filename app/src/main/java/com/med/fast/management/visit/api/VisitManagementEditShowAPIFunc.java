...
public class VisitManagementEditShowAPIFunc extends AsyncTask<VisitManagementEditShowAPI, Integer, ResponseAPI> {
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishVisitEditShow(responseAPI);
