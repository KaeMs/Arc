...
public class MiscShowAPIFunc extends AsyncTask<MiscShowAPI, Integer, ResponseAPI> {
    private MiscShowCreateIntf delegate;
    private Context context;

    public MiscShowAPIFunc(Context context, MiscShowCreateIntf delegate) {
        this.context = context;
        this.delegate = delegate;
    }

    @Override
    protected ResponseAPI doInBackground(MiscShowAPI... params) {
        ResponseAPI responseAPI = new ResponseAPI();
        try {
            String url = APIConstants.API_URL + APIConstants.MISC_SHOW;
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishMiscShow(responseAPI);
    }
}
