...
public class AccidentHistoryEditShowAPIFunc extends AsyncTask<AccidentHistoryEditShowAPI, Integer, ResponseAPI> {
    private AccidentHistoryEditIntf delegate;
    private Context context;
    private ProgressDialog progressDialog;

    public AccidentHistoryEditShowAPIFunc(Context context) {
    ...
    @Override
    protected ResponseAPI doInBackground(AccidentHistoryEditShowAPI... params) {
        ResponseAPI responseAPI = new ResponseAPI();
        try {
            String url = APIConstants.API_URL + APIConstants.ACCIDENT_EDIT_SHOW;
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishAccidentHistoryEditShow(responseAPI);
