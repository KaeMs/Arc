...
public class SummaryShowAPIFunc extends AsyncTask<SummaryShowAPI, Integer, ResponseAPI> {
    ...
    @Override
    protected ResponseAPI doInBackground(SummaryShowAPI... params) {
        ResponseAPI responseAPI = new ResponseAPI();
        try {
            String url = APIConstants.API_URL + APIConstants.SUMMARY_SHOW;
    ...
    protected void onPostExecute(ResponseAPI responseAPI) {
        ...
        delegate.onFinishSummaryShow(responseAPI);
    }
}
